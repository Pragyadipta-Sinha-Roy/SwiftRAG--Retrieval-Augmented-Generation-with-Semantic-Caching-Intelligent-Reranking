...
"""
# NOTE: SentenceTransformer, SemanticCache, FuzzyCache, ExactMatchCache are
# imported lazily inside run_tests block to avoid torch DLL crash at page load.
...
if run_tests:
    ...
    # Lazy imports — deferred to avoid torch DLL crash at Streamlit page load
