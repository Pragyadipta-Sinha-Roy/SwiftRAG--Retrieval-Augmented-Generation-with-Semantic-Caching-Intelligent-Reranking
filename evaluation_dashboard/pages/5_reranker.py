    ...
    if test_cross_encoder:
        ...
        cross_encoder_model = st.selectbox(
            ...
            help=(
                ...
                "Note: 'Alibaba-NLP/gte-reranker-modernbert-base' requires "
                "tokenizers>=0.21 and transformers>=4.48. "
                "Run `pip install -U tokenizers transformers` if you see a "
                "ModelWrapper deserialization error."
            )
        )
