    ...
    try:
        with st.spinner("🚀 Initializing TaskFlow Assistant..."):
            ...
            if chatbot.load_existing_vectorstore():
                ...
                st.info("Please run: python prepare_chromadb.py")
                return None
        ...
        st.info("Make sure GROQ_API_KEY is set and ChromaDB is prepared")
...
<div style='text-align: center; color: #666; padding: 20px;'>
    <p>🚀 Powered by Semantic Caching + RAG | Built with LangGraph & Groq</p>
