...
Uses sentence transformer embeddings for semantic matching of cached Q&A pairs.
"""
...
class SemanticCache:
    """
    Semantic cache using sentence transformer embeddings for meaning-based matching.
